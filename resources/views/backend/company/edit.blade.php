...
<form id="form-validation" action="{{route('company.update', $company->id ) }}" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
    <!-- Form Header -->
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text" value="{{$company->company_name}}" id="val_username" name="name" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text" value="{{$company->owner_name}}" id="val_email" name="owner" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="number" value="{{$company->phone}}" id="password" name="number" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <img src="{{asset($company->photo)}}" width="50px" alt="">
                </div>
            </div>
        </div>
