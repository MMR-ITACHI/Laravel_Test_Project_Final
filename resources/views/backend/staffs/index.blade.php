...
@section('breadcum')
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="{{ route('staff.index') }}">StaffList</a></li>
                    </ul>

@section('content')

<h3 class="page-header page-header-top"> <a href="{{route('staff.create')}}" class="btn btn-success ">Add Staff</a> <br>  Manager List <small>All information about Manager</small></h3>
                    ...
                    <table id="example-datatables" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-xs hidden-sm hidden-md"><i class="fa fa-envelope-o"></i>Staff Email</th>
                                <th><i class="fa fa-phone" aria-hidden="true"></i>Staff Phone Number</th>
                                <th><i class="fa fa-truck"></i> Branch Name</th>
                                
                                <th><i class="fa fa-bolt"></i>Branch Status</th>
                        ...
                        <td><span class="{{$staff->branch->status=='active' ? 'label label-success' : 'label label-warning'  }} ">{{$staff->branch->status}}</span></td>
                        <td>
                            <form action="{{route('staff.destroy', $staff->id)}}" method="post">
                                @csrf 
                                @method('DELETE')
                                <a href="" class="btn btn-info">View</a>
                                <a href="{{route('staff.edit', $staff->id)}}" class="btn btn-success">Edit</a>
