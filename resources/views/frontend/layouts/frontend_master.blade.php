...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('uploads/default_logo_photo.png') }}"/>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="{{route('index') }}">
                                <img src="{{asset('images/courier.jpg') }}" alt="Logo" />
                            </a>
               ...
               {{--  @php
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-partner wow fadeInUp" data-wow-delay="{{-- {{ $time }}s --}}">
                        <img src="{{ asset('uploads/company_photo') }}" alt="#">
                    </div>
                </div>
                {{-- @empty --}}
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget wow fadeInUp" data-wow-delay=".2s">
                        <div class="logo">
                            <a href="{{ route('index') }}"><img src="{{ asset('uploads/default_photo') }}" alt="logo"></a>
                        </div>
                ...
                <p class="text-center">Designed and Developed by <a href="">{{-- {{ $default_setting->app_name }} --}}</a></p>
            </div>
        </div>
    </footer>
    <!-- ========================= footer end ========================= -->
